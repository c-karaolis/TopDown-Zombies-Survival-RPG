Shader "HandpaintedVol1/URP/Handpainted_Grass_Lit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
            {
                ...
                Unity_Add_float(0, _GradientNoise_1B938AB4_Out_2, _Add_372F5890_Out_2);
                float _Subtract_6DB9C88F_Out_2;
                Unity_Subtract_float(_Add_372F5890_Out_2, 0.5, _Subtract_6DB9C88F_Out_2);
                ...
                float4 _UV_41128FB0_Out_0 = IN.uv0;
                float _Split_D708506E_R_1 = _UV_41128FB0_Out_0[0];
                float _Split_D708506E_G_2 = _UV_41128FB0_Out_0[1];
                float _Split_D708506E_B_3 = _UV_41128FB0_Out_0[2];
                float _Split_D708506E_A_4 = _UV_41128FB0_Out_0[3];
                float3 _Lerp_FE42F72D_Out_3;
                Unity_Lerp_float3(IN.AbsoluteWorldSpacePosition, (_Combine_A0BAC6E0_RGBA_4.xyz), (_Split_D708506E_G_2.xxx), _Lerp_FE42F72D_Out_3);
                float3 _Transform_393FA5B1_Out_1 = TransformWorldToObject(_Lerp_FE42F72D_Out_3.xyz);
