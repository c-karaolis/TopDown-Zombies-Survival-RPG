    ...
    public static class ManagerUtility
    {
        ...
        public static ViewName CreateViewNameFor(object obj)
        {
            ...
            if (obj is ItemCategoryAmount) {
                var amountViewName = new ItemCategoryAmountView(MainManagerWindow.Instance.Database);
                amountViewName.SetInteractable(false);
                return amountViewName;
            }

            if (obj is ItemDefinitionAmount) {
                var amountViewName = new ItemDefinitionAmountView(MainManagerWindow.Instance.Database);
                amountViewName.SetInteractable(false);
                return amountViewName;
            }

            if (obj is CurrencyAmount) {
                var amountViewName = new CurrencyAmountView(MainManagerWindow.Instance.Database);
                amountViewName.SetInteractable(false);
                return amountViewName;
            }

            if (obj is ItemAmount) {
                var amountViewName = new ItemAmountView(MainManagerWindow.Instance.Database);
                amountViewName.SetInteractable(false);
                return amountViewName;
            }
            ...
            object target, Object obj)
        {
            ...
            container.AddToClassList(ManagerStyles.s_AttributeViewNameAndValue_Value);
            return container;
        }
