...
namespace Opsive.UltimateInventorySystem.Editor.Managers
{
    ...
    /// </summary>
    [OrderedEditorItem("Item Categories", 2)]
    [RequireDatabase]
    [System.Serializable]
    public class ItemCategoryManager : InventorySystemObjectBaseManager<ItemCategory>
    {
        ...
        public override void BuildVisualElements()
        {
            ...
            () =>
            {
                itemCategoryParentPicker.OpenPopUpWindow(
            ...
            m_AttributeVisualElement = new AttributeVisualElement(m_MainManagerWindow.Database, true);
        ...
        {
            for (int i = 0; i < m_MainManagerWindow.Database.ItemCategories.Length; ++i) {
                if (m_MainManagerWindow.Database.ItemCategories[i].name == name) {
                    return false;
                }
            }
            return true;
        ...
        {
            var categories = m_MainManagerWindow.Database?.ItemCategories;
            if (categories == null) {
                return;
            }
        ...
        {
            return m_MainManagerWindow.Database?.ItemCategories;
        }
        ...
        private void ShowRelationshipTab(int index)
        {
            ...
            switch (index) {
                ...
                case 4: list = InventoryDatabaseUtility.DirectItemCategoryRecipes(m_MainManagerWindow.Database.CraftingRecipes, category); break; // Direct Recipes
                case 5: list = InventoryDatabaseUtility.InheritedItemCategoryRecipes(m_MainManagerWindow.Database.CraftingRecipes, category); break; // Inherit Recipes
        ...
        {
            return ItemCategoryEditorUtility.AddItemCategory(name, m_MainManagerWindow.Database, m_MainManagerWindow.GetDatabaseDirectory());
        }
        ...
        public override void OnRemove(int index)
        {
            ...
            if (removeItemCategory) {
                ItemCategoryEditorUtility.RemoveItemCategory(SelectedObject, m_MainManagerWindow.Database);
                OnSelected(-1);
            }
        }
