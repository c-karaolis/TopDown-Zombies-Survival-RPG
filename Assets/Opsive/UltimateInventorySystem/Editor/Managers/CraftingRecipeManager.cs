...
namespace Opsive.UltimateInventorySystem.Editor.Managers
{
    ...
    /// </summary>
    [OrderedEditorItem("Crafting Recipes", 5)]
    [RequireDatabase]
    [System.Serializable]
    public class CraftingRecipeManager : InventorySystemObjectBaseManager<CraftingRecipe>
    {
        ...
        protected ScriptableObjectInspectorView m_Other;
        ...
        public override void BuildVisualElements()
        {
            ...
            m_Other = new ScriptableObjectInspectorView();
        ...
        {
            for (int i = 0; i < m_MainManagerWindow.Database.CraftingRecipes.Length; ++i) {
                if (m_MainManagerWindow.Database.CraftingRecipes[i].name == name) {
                    return false;
                }
            }
            return true;
        ...
        {
            var recipes = m_MainManagerWindow.Database?.CraftingRecipes;
            if (recipes == null) {
                return;
            }
        ...
        {
            return m_MainManagerWindow.Database?.CraftingRecipes;
        }
        ...
        protected override void UpdateElements(CraftingRecipe recipe)
        {
            ...
            FieldInspectorView.AddField(
                ...
                (object obj) =>
                {
                    m_CraftingRecipeView.Refresh();
                    CraftingRecipeEditorUtility.SetCraftingRecipeDirty(SelectedObject, true);
                }, null, null, new object[] { true, m_MainManagerWindow.Database });
        ...
        public override void OnRemove(int index)
        {
            ...
            if (EditorUtility.DisplayDialog("Remove Crafting Recipe?",
                ...
                "Yes", "No")) {
                CraftingRecipeEditorUtility.RemoveCraftingRecipe(SelectedObject, m_MainManagerWindow.Database);
                OnSelected(-1);
            }
        }
    ...
    public class CraftingRecipeView : VisualElement
    {
        ...
        {
            AddToClassList(ManagerStyles.s_CraftingRecipeView);
