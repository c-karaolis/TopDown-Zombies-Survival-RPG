...
namespace Opsive.UltimateInventorySystem.Editor.VisualElements.ControlTypes
{
    ...
    public class ItemDefinitionAmountsControl : InventoryObjectAmountsControl
    {
        /// <summary>
    ...
    public class ItemDefinitionAmountsView : InventoryObjectAmountsView<ItemDefinitionAmounts, ItemDefinitionAmount, ItemDefinition>
    {
        ...
        protected override ItemDefinitionAmount CreateObjectAmount()
        {
            return new ItemDefinitionAmount();
        }
    ...
    public class ItemDefinitionAmountView : InventoryObjectAmountView<ItemDefinition>
    {
        ...
        public override IObjectAmount<ItemDefinition> CreateNewObjectAmount(object obj, int amount)
        {
            return new ItemDefinitionAmount((ItemDefinition)obj, amount);
        }
