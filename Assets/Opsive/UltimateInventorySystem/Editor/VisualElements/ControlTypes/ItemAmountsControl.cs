...
namespace Opsive.UltimateInventorySystem.Editor.VisualElements.ControlTypes
{
    ...
    public class ItemAmountsControl : InventoryObjectAmountsControl
    {
        /// <summary>
    ...
    public class ItemAmountsView : InventoryObjectAmountsView<ItemAmounts, ItemAmount, Item>
    {
        ...
        protected override ItemAmount CreateObjectAmount()
        {
            return ItemAmount.One;
        }
    ...
    public class ItemAmountView : InventoryObjectAmountView<Item>
    {
        ...
        public override IObjectAmount<Item> CreateNewObjectAmount(object obj, int amount)
        {
            return new ItemAmount((Item)obj, amount);
        }
