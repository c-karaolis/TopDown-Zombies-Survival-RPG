...
namespace Opsive.UltimateInventorySystem.Editor.VisualElements.ControlTypes
{
    ...
    public class CurrencyAmountsControl : InventoryObjectAmountsControl
    {
        /// <summary>
    ...
    public class CurrencyAmountsView : InventoryObjectAmountsView<CurrencyAmounts, CurrencyAmount, Currency>
    {
        ...
        protected override CurrencyAmount CreateObjectAmount()
        {
    ...
    public class CurrencyAmountView : InventoryObjectAmountView<Currency>
    {
        ...
        public override IObjectAmount<Currency> CreateNewObjectAmount(object obj, int amount)
        {
            return new CurrencyAmount((Currency)obj, amount);
        }
