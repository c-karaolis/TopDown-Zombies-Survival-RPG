    ...
    public class AttributeViewName : ViewName<AttributeBase>
    {
        ...
        public AttributeViewName(bool header)
        {
            ...
            if (m_Header) {
                ...
                m_Label.AddToClassList(ManagerStyles.s_AttributeViewName_LabelSmall);
            } else {
                m_Label.AddToClassList(ManagerStyles.s_AttributeViewName_Label);
            }
            m_SourceBox = new ColoredBox();
            m_InheritBox = new ColoredBox();

            AddToClassList(ManagerStyles.s_AttributeViewName);
            Add(m_SourceBox);
            Add(m_InheritBox);
            Add(m_Label);
        ...
        protected void RefreshViewName()
        {
            ...
            m_SourceBox.SetClickAction(() => Managers.MainManagerWindow.NavigateTo(sourceCategory));
            ...
            m_InheritBox.SetClickAction(() => Managers.MainManagerWindow.NavigateTo(inheritObject));
        }
