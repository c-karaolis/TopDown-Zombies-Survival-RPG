...
namespace Opsive.UltimateInventorySystem.Editor.Inspectors
{
    ...
    public class AttributeBindingView : VisualElement
    {
        ...
        /// Constructor.
        /// </summary>
        public AttributeBindingView()
        {
            AddToClassList(ManagerStyles.s_AttributeBinding);
            ...
            m_ObjectField.AddToClassList(ManagerStyles.s_AttributeBindingObject);
            ...
            m_PropertyPathField = new PopupField<string>(choices, 0,
                propertyPath =>
                {
                    if (m_AttributeBinding == null || m_AttributeBinding.PropertyPath == propertyPath ||
                        m_AttributeBinding.PropertyPath == string.Empty && propertyPath == "(none)") { return propertyPath; }
            ...
            m_PropertyPathField.AddToClassList(ManagerStyles.s_AttributeBindingPopup);
        ...
        protected void Refresh()
        {
            ...
            m_PropertyPathField.value = choices[selectedIndex];
        }
