...
namespace Opsive.UltimateInventorySystem.Editor.Inspectors
{
    ...
    public class ItemCategoryAttributeBindingView : VisualElement
    {
        ...
        public ItemCategoryAttributeBindingView(InventorySystemDatabase database)
        {

            MainManagerWindow.OnLostFocusEvent -= Refresh;
            MainManagerWindow.OnLostFocusEvent += Refresh;
        ...
        {
            var attributeBindingView = new AttributeBindingView();
    ...
    public class ItemCategoryAttributeNameBindingView : ItemCategoryAttributeBindingView
    {
        ...
        /// </summary>
        /// <param name="database">The database.</param>
        public ItemCategoryAttributeNameBindingView(InventorySystemDatabase database) : base(database)
        {
        }
        ...
        public ItemCategoryAttributeNameBindingView(InventorySystemDatabase database, bool hidePropertyPath) :
            base(database)
        {
        ...
        {
            var attributeBindingView = new AttributeNameBindingView();
