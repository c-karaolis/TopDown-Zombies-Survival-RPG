...
namespace Opsive.UltimateInventorySystem.Demo.UI.Menus.Upgrade
{
    ...
    public class ItemUpgradePanel : DisplayPanel
    {
        ...
        protected ItemAmount? m_BeforePreviewItemAmount;
        ...
        public override void Setup(DisplayPanelManager manager, bool force)
        {
            ...
            if (m_Slots == null) { m_Slots = new ItemAmounts(3); }
        ...
        public void SetUpgradePreviewInSlot(Item item, int index)
        {
            ...
            if (!m_BeforePreviewItemAmount.HasValue) {
                m_BeforePreviewItemAmount = m_Slots[index];
            }
        ...
        /// </summary>
        /// <param name="index">The slot index.</param>
        public void ResetFromPreview(int index)
        {
            if (index < 0 || index > m_Slots.Count) {
                return;
            }

            if (!m_BeforePreviewItemAmount.HasValue) { return; }

            m_Slots[index] = m_BeforePreviewItemAmount.Value;
            m_BeforePreviewItemAmount = null;
