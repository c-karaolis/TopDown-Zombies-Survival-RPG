...
namespace Opsive.UltimateInventorySystem.UI.Panels.Save
{
    ...
    /// </summary>
    public class SaveViewDrawer : ViewDrawer<SaveData>
    {
        ...
        public override GameObject GetViewPrefabFor(SaveData saveData)
        {
        ...
        protected override void BeforeDrawingBox(int index, View<SaveData> view, SaveData element)
        {
