...
namespace Opsive.UltimateInventorySystem.DropsAndPickups
{
    ...
    public class ItemPickup : PickupBase
    {
        ...
        protected override void OnInteractInternal(IInteractor interactor)
        {
            ...
            AddItemToCollection(itemCollection);
        }
        ...
        protected virtual void AddItemToCollection(ItemCollection itemCollection)
        {
            itemCollection.AddItem(m_ItemObject.ItemInfo);
            PlaySound();
        }
